...
export default function CanvasMigrationModal({
  ...
  const canvasLabel = canvasProvider === 'gemini' ? 'iSupply AI Studio (Gemini)' : 'GPT-Image-2 (OpenAI)';
  const globalLabel = globalProvider === 'gemini' ? 'iSupply AI Studio (Gemini)' : 'GPT-Image-2 (OpenAI)';
