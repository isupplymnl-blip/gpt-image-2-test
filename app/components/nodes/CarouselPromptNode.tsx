...
export default function CarouselPromptNode({ id, data }: NodeProps<CarouselNodeData>) {
  const { onGenerateCarousel, onUpdateData, onUpdateSettings, onSelectNode, onDeleteNode, connectingFromId, onStartConnect, onCompleteConnect, onAddCarouselSlide, onRemoveCarouselSlide, activeProvider } = useContext(StudioContext);
